...
The script lives at `.claude/skills/transcribe/scripts/transcribe_diarize.py`, relative to the project root. Always invoke with `uv run --script` (the script declares its deps via PEP 723). Run with `--help` for the full flag list.
